    ...
    context 'when uid is present' do
      ...
      context 'when params are blank' do
        ...
        it 'renders an error' do
          ...
          expect_body.to eq(error: 'service_account_uid is missing, service_account_uid is empty, provider_uid is missing, provider_uid is empty, service_account_email is missing, service_account_email is empty')
        end
      end
